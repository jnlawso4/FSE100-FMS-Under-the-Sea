...
function matchingGame(variation) {
  ...
  image(matchingpage, 0, 0, 700, 600);
  ...
  fill('black');
  textSize(35);
  text("Match the Shapes", 350, 65);
  textSize(20);
  text("Click a shape and its corresponding shape to match them.", 350, 100);
  
  // Score
  textSize(25);
  text("Score: " + scoreValue, 575, 65);
