function puzzleGame() {
  ...
  textSize(20);
  text("Click and drag a puzzle piece to bring it to the correct spot.", 350, 100);
...
// Dragging logic
  ...
  if (position1 == true &&
      ...
      fill('#FFF6A5')
      stroke('#FFB6C1');
      rect(180,125,350,400,30);
      textSize(35);
      noFill();
      noStroke();
      fill('pink')
      text("Congratulations!!", 355, 175);
      textSize(12);
      textStyle(BOLD);
      text("Click the return button to go back to the activity page", 355,500);
      textStyle(NORMAL);
      image(croosh,205, 200,300,275);
      }
